...
namespace IMUtil
{
    ...
    public:
        ...
        static IMCodec::ImageSharedPtr Transform(IMUtil::AxisAlignedTransform transform, IMCodec::ImageSharedPtr image)
        {
            using namespace std;
            using namespace IMCodec;


            if (transform.rotation != AxisAlignedRotation::None || transform.flip != AxisAlignedFlip::None)
            {
                ...
                if (transform.rotation == AxisAlignedRotation::Rotate90CW || transform.rotation == AxisAlignedRotation::Rotate90CCW)
